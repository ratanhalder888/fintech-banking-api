    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_birth', models.DateField(default=datetime.date(1993, 9, 18), verbose_name='Date of Birth')),
                ('country_of_birth', django_countries.fields.CountryField(default='BD', max_length=2, verbose_name='Country of Birth')),
                ('place_of_birth', models.CharField(default='Unknown', max_length=50, verbose_name='Place of Birth')),
                ('marital_status', models.CharField(choices=[('married', 'Married'), ('single', 'Single'), ('divorced', 'Divorced'), ('widowed', 'Widowed'), ('separated', 'Separated'), ('unknown', 'Unknown')], default='unknown', max_length=20, verbose_name='Marital Status')),
                ('means_of_identification', models.CharField(choices=[('drivers_license', 'Drivers License'), ('national_id', 'National ID'), ('passport', 'Passport')], default='drivers_license', max_length=20, verbose_name='Means of Identification')),
                ('id_issue_date', models.DateField(default=datetime.date(2001, 1, 1), verbose_name='ID or Passport Issue Date')),
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(default='+8801670267006', max_length=30, region=None, verbose_name='Phone Number')),
                ...
                ('employment_status', models.CharField(choices=[('self_employed', 'Self Employed'), ('employed', 'Employed'), ('unemployed', 'Unemployed'), ('retired', 'Retired'), ('student', 'Student')], default='self_employed', max_length=20, verbose_name='Employment Status')),
