# Generated by Django 6.0.3 on 2026-04-28 09:44

import core_apps.user_auth.managers
import core_apps.user_auth.utils
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.BigIntegerField(default=core_apps.user_auth.utils.generate_user_id, editable=False, primary_key=True, serialize=False)),
                ('username', models.CharField(max_length=32, unique=True, verbose_name='Username')),
                ('security_question', models.CharField(choices=[('maiden_name', "What is your mother's maiden name?"), ('favorite_color', 'What is your favorite color?'), ('birth_city', 'What is the city where you were born'), ('childhood_friend', 'What is the name of your childhood best friend?')], max_length=30, verbose_name='Security Questions')),
